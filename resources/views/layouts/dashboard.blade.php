...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('images/dashboard/icons/icon-48x48.png') }}" />
    ...
    <nav id="sidebar" class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
            <a class="sidebar-brand" href="{{ route('home') }}">
                <span class="d-flex justify-content-center">{{ strtoupper(config('app.name')) }}</span>
            </a>
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item {{ request()->is('buttons') ? 'active' : '' }}">
                ...
                <li class="sidebar-item {{ request()->is('cards') ? 'active' : '' }}">
                ...
                <li class="sidebar-item {{ request()->is('tables') ? 'active' : '' }}">
                    <a class="sidebar-link" href="{{ route('tables') }}">
                        <i class="align-middle" data-feather="menu"></i> <span class="align-middle">Tables</span>
                    </a>
                </li>
                ...
                <ul class="navbar-nav navbar-align">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="messagesDropdown">
                            ...
                            <div class="list-group">
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="{{asset('images/dashboard/avatars/avatar-5.jpg') }}" class="avatar img-fluid rounded-circle" alt="Vanessa Tucker">
                                        </div>
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="{{asset('images/dashboard/avatars/avatar-2.jpg') }}" class="avatar img-fluid rounded-circle" alt="William Harris">
                                        </div>
                                        <div class="col-10 ps-2">
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="{{asset('images/dashboard/avatars/avatar-4.jpg') }}" class="avatar img-fluid rounded-circle" alt="Christina Mason">
                                        </div>
                                        <div class="col-10 ps-2">
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="{{asset('images/dashboard/avatars/avatar-3.jpg') }}" class="avatar img-fluid rounded-circle" alt="Sharon Lessman">
                                        </div>
                                        <div class="col-10 ps-2">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                            <img src="{{asset('images/dashboard/avatars/avatar.jpg') }}" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">Charles Hall</span>
                        </a>
